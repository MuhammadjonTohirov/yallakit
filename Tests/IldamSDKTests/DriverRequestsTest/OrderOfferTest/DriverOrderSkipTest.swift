...
final class DriverOrderSkipTest: XCTestCase {
    func test_orderSkipTest() async {
        ...
        let gateway = OrderSkipGateway()
        let result = try? await gateway.skipOrder(orderId: 1969683, status: "canceled", reasonComment: "Assa")
