...
final class DriverTransportListTest: XCTestCase {
    func test_getTransport() async {
        ...
        let gateway = DriverTransportMarkModelsGateway()
        let result = try? await gateway.fetchCarList()
