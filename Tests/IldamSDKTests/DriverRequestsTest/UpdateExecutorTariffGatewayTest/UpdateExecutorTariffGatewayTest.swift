//
//  UpdateExecutorTariffGatewayTest.swift
//  YallaKit
//
//  Created by MuhammadAli on 07/05/25.
//UpdateExecutorTariffGateway
...
final class UpdateExecutorTariffGatewayTest: XCTestCase {
    func test_fetchTariff() async {
        ...
        let gateway = UpdateExecutorTariffGateway()
        let result = try? await gateway.fetchExecutorTariffs(tariffId: [1,2])
