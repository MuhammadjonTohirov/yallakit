...
extension CreateExecutorResponse {
    public struct ExecutorProfile: Codable, Sendable {
        ...
        init?(from network: DNetDriverRegisterResponse.DNetCreateExecutorResponse?) {
        ...
        public struct NewExecutorBrand: Codable, Sendable {
            ...
            init(from network: DNetDriverRegisterResponse.DNetCreateNewExecutorMeBrand) {
                self.id = network.id
