...
public struct DriverPlanShowResponse: DNetResBody {
    public let cost: Int
    ...
    public init(cost: Int, deactivation: Bool, description: String, id: Int, limitTime: Int, limitUnit: String, name: String, orderPayCost: Int, orderPayPresent: Int) {
        self.cost = cost
    ...
    init(from network: DNetResPlanShowResult) {
