...
public extension Date {
    static let serverFormat: String = "yyyy-MM-dd'T'HH:mm:ss.SSSSSS"
    ...
    func after(minuts: Int) -> Date {
        let date = Calendar.current.date(byAdding: DateComponents(minute: minuts), to: self)
        return date ?? self
    }
