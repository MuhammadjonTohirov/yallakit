...
final public class UserSettings: @unchecked Sendable {
    ...
    @codableWrapper(key: "language", Language.russian.code)
    ...
    @available(*, deprecated, message: "Move UI concerns out of UserSettings. Use UIApplication directly or a ThemeManager.")
    @MainActor
